                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <div class="card-header">
                                ...
                                <h3 class="card-title">Chỉnh sửa học viên</h3><br>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" class="form-control" value="{{ $student->birthday }}"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <img type="hidden" width="300px" height="280px" id="blah1"
                                                src="{{ asset($student->image) ?? $request->inputFile }}" alt="Hình ảnh" />
                                            @error('image')
                                            <div><code>{{ $message }}</code></div>
                                            @enderror
                                        </div>
