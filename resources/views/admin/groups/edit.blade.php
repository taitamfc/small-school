            ...
            <div class="row">
              <div class="col-md-12">
                ...
                @endif
                  ...
                  <div class="card-body">
                      <form action="{{ route('groups.update',$group->id) }}" method="POST" enctype="multipart/form-data" class="form">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="name" value="{{ $group->name ?? old('name') }}" type="text" class="form-control"
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                              ...
                              <textarea name="description" type="text" class="form-control"
                                  id="description" placeholder="Nhập Mô Tả Chức Vụ(Không bắt buộc)">{{ $group->description ?? old('description') }}</textarea>
                                  @error('discription')
                                  <div ><code>{{ $message }}</code></div>
                                @enderror
                          </div>
