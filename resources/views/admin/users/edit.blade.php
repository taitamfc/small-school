                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" value="{{ $user->user_name }}"
                                                name="user_name" placeholder="Nhập tên đăng nhập">
                                            @error('user_name')
                                            <div><code>{{ $message }}</code></div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <img type="hidden" width="100px" height="100px" id="blah1"
                                                src="{{ $user->avatar != null ? asset($user->avatar) : 'https://vivureviews.com/wp-content/uploads/2022/08/avatar-vo-danh-10.png' }}"
                                                alt=""
