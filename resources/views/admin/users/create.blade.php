                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="full_name"
                                                value="{{ old('full_name') ? old('full_name') : request()->full_name }}"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="user_name"
                                                value="{{ old('user_name') ? old('user_name') : request()->user_name }}"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="password" class="form-control" name="password"
                                                value="{{ old('password') ? old('password') : request()->password }}"
                                    ...
                                    <div class="row">
										<div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" value="{{ $user->phone }}"
                                                name="phone" placeholder="Nhập phone">
                                            @error('phone')
                                            <div><code>{{ $message }}</code></div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <img type="hidden" width="300px" height="280px" id="blah"
                                                src="{{ old('inputFile') ? old('inputFile') : request()->inputFile }}"
                                                alt="" />
