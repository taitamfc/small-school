                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form action="{{ route('teachers.tasks.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" name="recurrence"
                                                value="1" id="recurrence" data-bootstrap-switch
                                                @checked(old('recurrence', 'none' )==='1' )>
                                    ...
                                    <div class="form-group" id="recurrence-wrapper" >
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" name="recurrence_days[]"
                                                value="{{ $week_day }}" id="{{ $week_day }}" data-bootstrap-switch>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a class="btn btn-danger" href="{{ route('teachers.tasks.index') }}">Trở về</a>
                                </div>
                            </form>
                        </div>
                    </div>
