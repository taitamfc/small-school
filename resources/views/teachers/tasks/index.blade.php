            ...
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        ...
                        <a class="btn btn-warning" href="{{ route('teachers.tasks.create') }}">Thêm yêu cầu </a>
                                ...
                                <table class="table" style="text-align: center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ date_format(new DateTime($item->start_time), 'H:i:s - d/m/Y') ?? '' }}
                                            </td>
                                            <td>{{ date_format(new DateTime($item->end_time), 'H:i:s - d/m/Y') ?? '' }}
                                            </td>
                                            <td>{{ $item->teacher->name }}</td>
                                            <td>{{ $item->statuses[$item->status] }}</td>
                                            <td>
                                                <form action="{{route('teachers.tasks.destroy',$item->id)}}" method="post">
                                                    @method('DELETE')
                                                    @csrf
                                                    <a class="btn btn-warning"
                                                        href="{{route('teachers.tasks.edit', $item->id)}}">Sửa</a>
